...
#randomize the sample and split into llm, validate and final test set
...
#with open('data/plain_' + mode + '_dataset-llm-X_'+w2v + "__" + mode2, 'wb') as fp:
#  pickle.dump(TrainX, fp)
#with open('data/plain_' + mode + '_dataset-llm-Y_'+w2v + "__" + mode2, 'wb') as fp:
...
#validate data on llm and test set

for dataset in ["llm","test","finaltest"]:
